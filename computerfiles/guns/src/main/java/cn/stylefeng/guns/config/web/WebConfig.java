...
public class WebConfig implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(new RestApiInteceptor()).addPathPatterns("/cookinfoApi/**");
        registry.addInterceptor(new RestApiInteceptor()).addPathPatterns("/chinfoApi/**");
        registry.addInterceptor(new RestApiInteceptor()).addPathPatterns("/agritainmentApi/**");
        registry.addInterceptor(new RestApiInteceptor()).addPathPatterns("/rtagmtApi/**");
    }
