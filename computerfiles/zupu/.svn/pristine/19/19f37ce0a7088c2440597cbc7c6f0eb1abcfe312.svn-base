...
<div
    ...
    class="x-panel x-full" style="background-color:rgba(242, 242, 242, 1)" xid="panel1">
        <div class="x-panel-top" xid="top1">
            <div component="$UI/system/components/justep/titleBar/titleBar" title="添加教育经历"   style="background-color:rgba(231, 64, 58, 1)" 
          class="x-titlebar">
              ...
              onClick="{operation:'window.close'}" xid="backBtn">
                ...
                <div class="x-titlebar-title">添加教育经历</div>
        ...
        <div class="x-panel-content content" xid="content1">
            ...
            <div class="all_list_all">
                ...
                <div class="all_list_right_time">
                    <input class="start_inputs" id="start_date" required="true" readonly="readonly" placeholder="选择入校时间"/>
                    <span>至</span>
                    <input class="end_inputs" id="end_date" required="true"  readonly="readonly" placeholder="选择毕业时间"/>
                </div>
            </div>  
