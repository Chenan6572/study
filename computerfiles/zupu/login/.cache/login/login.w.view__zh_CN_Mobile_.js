...
var __parent0=require('$model/UI2/zupu/login/login'); 
var __result = __parent1._extend(__parent0).extend({
	...
	this.__id='';
	this.__cid='cmIZRVf';
	this._flag_='fbf683d0b1ec3fd870d860327af2c440';
	this._wCfg_={};
	this._appCfg_={};
