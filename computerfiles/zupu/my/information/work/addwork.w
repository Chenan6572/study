...
<div
    ...
    class="x-panel x-full" style="background-color:rgba(242, 242, 242, 1)" xid="panel1">
        <div class="x-panel-top" xid="top1">
            <div component="$UI/system/components/justep/titleBar/titleBar" title="添加工作经历"   style="background-color:rgba(231, 64, 58, 1)" 
          class="x-titlebar">
              ...
              onClick="{operation:'window.close'}" xid="backBtn">
                ...
                <div class="x-titlebar-title">添加工作经历</div>
        ...
        <div class="x-panel-content content" xid="content1">
            <div class="all_list_all">
                ...
                <div class="all_list_right">
                    <input type="text" id="company_name" required="required" placeholder="请输入公司（必填）"/>
                </div>
            </div>
            <div class="all_list_all">
                <div class="all_list_left">部门</div>
                <div class="all_list_right">
                    <input type="text" id="related_depart" placeholder="请输入部门（必填）"/>
                </div>
            </div>
            <div class="all_list_all">
                <div class="all_list_left">职位</div>
                <div class="all_list_right">
                    <input   type="text" id="position" placeholder="请选择职位（必填）"/>
                </div>
            </div>
            <div class="all_list_all">
            ...
            <div class="btns" bind-click="addwork">保 存</div>
        </div>
    </div>
</div>